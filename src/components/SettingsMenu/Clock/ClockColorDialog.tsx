            ...
            <div className="bg-muted/10 rounded-2xl border border-border/10 p-4 flex items-center justify-between transition-all hover:bg-muted/20">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/40 leading-none mb-1">
                    Master Control
                  </span>
              ...
              {(
                ...
                >
                  ...
                  <div className="relative flex items-baseline justify-center py-2 z-10 text-foreground">
                    ...
                    <span className="ml-1 text-[10px] opacity-30 font-bold">
                      PM
                    </span>
                  </div>
                </button>
        ...
        <DialogFooter className="p-6 border-t border-white/5 bg-black/40 flex-shrink-0">
          <div className="flex w-full items-center justify-end gap-3">
            <Button
              ...
              className="h-10 px-6 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-white/5"
            >
              {t("cancel")}
            </Button>
            <Button
              onClick={handleSave}
              className="h-10 px-8 rounded-xl text-[10px] font-black uppercase tracking-widest bg-primary hover:bg-primary/90 shadow-xl shadow-primary/20"
            >
              {t("saveChanges")}
            </Button>
          </div>
